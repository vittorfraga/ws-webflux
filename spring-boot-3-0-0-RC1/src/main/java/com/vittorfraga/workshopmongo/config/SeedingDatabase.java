package com.vittorfraga.workshopmongo.config;

import com.vittorfraga.workshopmongo.entities.Post;
...
public class SeedingDatabase implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Mono<Void> deletedUsers = userRepository.deleteAll();
        deletedUsers.subscribe();

        Mono<Void> deletedPosts = postRepository.deleteAll();
        deletedPosts.subscribe();
